...
try {
    ...
    # Embedded ServerSync and the scoped FreshWorld edit/cleanup adapter use original metadata.
    Require-Method ($game.GetType('ZRpc')) 'HandlePackage' 'ZPackage' 'System.Void'
    Require-Method ($game.GetType('ZRpc')) 'Unregister' 'System.String' 'System.Void'
    Require-Method ($game.GetType('ZNet')) 'Awake' '' 'System.Void'
    Require-Method ($game.GetType('ZNet')) 'OnNewConnection' 'ZNetPeer' 'System.Void'
    Require-Method ($game.GetType('ZNet')) 'RPC_PeerInfo' 'ZRpc,ZPackage' 'System.Void'
    Require-Method ($game.GetType('ZNet')) 'GetPeer' 'ZRpc' 'ZNetPeer'
    Require-Method ($game.GetType('ZNet')) 'IsAdmin' 'System.String' 'System.Boolean'
    Require-Method ($game.GetType('ZNet')) 'Disconnect' 'ZNetPeer' 'System.Void'
    Require-Method ($game.GetType('FejdStartup')) 'ShowConnectError' 'ZNet/ConnectionStatus' 'System.Void'
    Require-Field ($game.GetType('ZRpc')) 'm_socket' 'ISocket'
    Require-Field ($game.GetType('ZNet')) 'm_adminList' 'SyncedList'
    Require-Field ($game.GetType('ZRoutedRpc')) 'm_peers' 'System.Collections.Generic.List`1<ZNetPeer>'
    Require-Field ($game.GetType('ZRoutedRpc')) 'm_functions' 'System.Collections.Generic.Dictionary`2<System.Int32,RoutedMethodBase>'
